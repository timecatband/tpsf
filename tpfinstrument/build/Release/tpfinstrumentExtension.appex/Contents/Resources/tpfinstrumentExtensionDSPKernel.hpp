//
//  tpfinstrumentExtensionDSPKernel.hpp
...
#import "tpfinstrumentExtension-Swift.h"
#import "tpfinstrumentExtensionParameterAddresses.h"

/*
 tpfinstrumentExtensionDSPKernel
...
public:
    ...
    // Add a case for each parameter in tpfinstrumentExtensionParameterAddresses.h
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case tpfinstrumentExtensionParameterAddress::gain:
                mGain = value;
                break;
        }
    }
    ...
    void handleMIDIEventList(AUEventSampleTime now, AUMIDIEventList const* midiEvent) {
        auto visitor = [] (void* context, MIDITimeStamp timeStamp, MIDIUniversalMessage message) {
            auto thisObject = static_cast<tpfinstrumentExtensionDSPKernel *>(context);
