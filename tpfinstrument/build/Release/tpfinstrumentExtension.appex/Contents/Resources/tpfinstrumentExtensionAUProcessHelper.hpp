//
//  tpfinstrumentExtensionAUProcessHelper.hpp
...
#include <vector>
#include "tpfinstrumentExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(tpfinstrumentExtensionDSPKernel& kernel, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    tpfinstrumentExtensionDSPKernel& mKernel;
