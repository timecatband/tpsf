//
//  tpfinstrumentExtensionAudioUnit.mm
//  tpfinstrumentExtension
//
//  Created by Robert Carr on 5/5/24.
//

#import "tpfinstrumentExtensionAudioUnit.h"

#import <AVFoundation/AVFoundation.h>
#import <CoreAudioKit/AUViewController.h>

#import "tpfinstrumentExtensionAUProcessHelper.hpp"
#import "tpfinstrumentExtensionDSPKernel.hpp"


// Define parameter addresses.

@interface tpfinstrumentExtensionAudioUnit ()
...
@implementation tpfinstrumentExtensionAudioUnit {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    tpfinstrumentExtensionDSPKernel _kernel;
...
- (void)setupParameterCallbacks {
    ...
    __block tpfinstrumentExtensionDSPKernel *kernel = &_kernel;
