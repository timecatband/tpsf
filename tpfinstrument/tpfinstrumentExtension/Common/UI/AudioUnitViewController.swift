...
private let log = Logger(subsystem: "timecatlabs.tpfinstrumentExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<tpfinstrumentExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try tpfinstrumentExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? tpfinstrumentExtensionAudioUnit else {
            log.error("Unable to create tpfinstrumentExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(tpfinstrumentExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = tpfinstrumentExtensionMainView(parameterTree: observableParameterTree)
