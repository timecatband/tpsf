//
//  TimecatLabsSynthExtensionAUProcessHelper.hpp
...
#include <vector>
#include "TimecatLabsSynthExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(TimecatLabsSynthExtensionDSPKernel& kernel, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    TimecatLabsSynthExtensionDSPKernel& mKernel;
