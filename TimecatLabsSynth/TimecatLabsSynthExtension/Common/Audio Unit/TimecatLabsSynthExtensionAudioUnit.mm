//
//  TimecatLabsSynthExtensionAudioUnit.mm
//  TimecatLabsSynthExtension
//
//  Created by Robert Carr on 5/6/24.
//

#import "TimecatLabsSynthExtensionAudioUnit.h"

#import <AVFoundation/AVFoundation.h>
#import <CoreAudioKit/AUViewController.h>

#import "TimecatLabsSynthExtensionAUProcessHelper.hpp"
#import "TimecatLabsSynthExtensionDSPKernel.hpp"


// Define parameter addresses.

@interface TimecatLabsSynthExtensionAudioUnit ()
...
@implementation TimecatLabsSynthExtensionAudioUnit {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    TimecatLabsSynthExtensionDSPKernel _kernel;
...
- (void)setupParameterCallbacks {
    ...
    __block TimecatLabsSynthExtensionDSPKernel *kernel = &_kernel;
...
- (void) setModel:(NSString *)model {
    _kernel.setModel(model);
}

- (void) setEffectModel:(NSString *)effectModel {
    _kernel.setEffectModel(effectModel);
}
