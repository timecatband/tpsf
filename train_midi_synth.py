...
effect_chain = build_effect_chain("SubtractiveSynth[sr=44100], Envelope[stages=4], ComplexOscillator[starting_freq=3.0,sr=44100],ComplexOscillator[starting_freq=1.5,sr=44100],ParametricIRReverb[length=44100,sampling_rate=44100],PeriodicAllPassFilter[order=3],SoftClipping,Lowpass[sample_rate=44100],NotchFilter[sample_rate=44100],BiquadEq[sample_rate=44100],BiquadEq[sample_rate=44100]")
